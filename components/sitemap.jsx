...
const Sitemap = () => (
  <div className="HorizontalGrid HorizontalGrid--limited HorizontalGrid--withGutters u-largeMargin u-exceptSmall">
    ...
    <div className="HorizontalGrid-cell">
      <div className="SitemapTopic">
        ...
        <ul className="SitemapTopic-links">
          ...
          <li><a href="https://twitter.com/subvisual" target="_blank" rel="noopener noreferrer" className="SitemapTopic-link">Twitter</a></li>
          <li><a href="/https://www.facebook.com/subvisual.co" target="_blank" rel="noopener noreferrer" className="SitemapTopic-link">Facebook</a></li>
          <li><a href="https://github.com/subvisual" target="_blank" rel="noopener noreferrer" className="SitemapTopic-link">Github</a></li>
          <li><a href="https://dribbble.com/subvisual" target="_blank" rel="noopener noreferrer" className="SitemapTopic-link">Dribbble</a></li>
        </ul>
      </div>
    </div>
  </div>
